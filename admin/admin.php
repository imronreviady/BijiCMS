...
if ($_SESSION['login'] == 0) {
	...
	if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser']) AND $_SESSION['login'] == 0) {
		...
		if(isset($_POST['language'])) {
			...
			$langcore = new Core();
			$langcore->flash->success($GLOBALS['_']['setting_message'], 'admin.php?mod=setting');
		}
?>
...
<body class="fixed-left">
	...
	<?php
		$alertalldel = new Core();
		echo $alertalldel->html->dialogDeleteAll();
	?>

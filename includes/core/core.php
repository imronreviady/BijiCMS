 ...
 *
 *
 * Ini adalah file core BijiCMS yang memuat semua library penunjang.
 * This is a file core from BijiCMS which contains all the supporting libraries.
 *
*/

/**
 * Mendeklarasi Core Path BijiCMS
 *
 * Declaration Core Path BijiCMS
 *
 * Thanks to Mang Aay
 *
*/
...
/**
 * Memasukkan library utama BijiCMS
 *
 * Include BijiCMS library
 *
*/
...
/**
 * Menginisialisasi semua class dari bijicms dan vendor
 *
 * Initialize all class from bijicms and vendor
 *
*/
...
class Core
{
	...
	public function __construct()
	{
		...
		*/
		...
		/**
		 * Menginisialisasi semua class dari bijicms dan vendor ke variabel
		 *
		 * Initialize all class from bijicms and vendor to variabel
		 *
		*/
		$this->pdo = null;
		...
		$this->connect = array('user' => DATABASE_USER, 'pass' => DATABASE_PASS, 'db' => DATABASE_NAME, 'host' => DATABASE_HOST);
		...
		$this->setting = $this->db->from('setting')->fetchAll();
		$this->theme = $this->db->from('theme')->where('active', 'Y')->limit(1)->fetch();
	}

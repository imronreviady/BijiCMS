 ...
 *
 *
 * Ini adalah file utama javascript BijiCMS yang memuat semua javascript di dashboard.
 * This is a main javascript file from BijiCMS which contains all javascript in dashboard.
 *
*/
...
function($) {
	...
	var App = function() {
		this.VERSION = "1.0", 
		this.AUTHOR = "BijiCMS", 
		this.SUPPORT = "imronreviady2@gmail.com", 

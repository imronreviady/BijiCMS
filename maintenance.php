...
<body>
	<article class="col-md-8 col-md-offset-2 text-center">
		...
		<div>
			<p>Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. If you need to you can always <a href="mailto:<?=$core->setting[5]['value'];?>">contact us</a>, otherwise we&rsquo;ll be back online shortly!</p>
			<p class="text-small">&mdash; <?=$core->setting[0]['value'];?></p>
		</div>
	</article>
</body>
</html>
